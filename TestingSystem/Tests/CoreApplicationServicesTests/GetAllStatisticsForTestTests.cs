...
namespace Tests.CoreApplicationServicesTests
{
    ...
    public class GetAllStatisticsForTestTests
    {
        ...
        public async Task<Tuple<short, int, int>> CreateTestWithQuestions(string examinerId, string testTitle)
        {
        ...
        public async Task GetAllTestStatisticSuccess()
        {
            ...
            ICollection<Core.ApplicationServices.DTOs.TestStatisticDTO> testStatistics = await TestStatisticService.GetAllStatisticsForTest(testId, externalEId);
        ...
        public async Task GetAllTestStatisticFail2()
        {
            ...
            await Assert.ThrowsExceptionAsync<ArgumentNullException>(async () => await TestStatisticService.GetAllStatisticsForTest(100, externalEId), $"Test does not exist");
